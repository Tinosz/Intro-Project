var kittenIdle = document.getElementById("object2");
kittenIdle.src = "Aset/kitten/kitten-idle.gif";
function switchImage() {
    const images = ['Aset/kitten/kitten-idle.gif', 'Aset/kitten/idle.gif', 'Aset/kitten/idle3.gif', 'Aset/kitten/idle4.gif']; // an array of image file names
  ...
  function changetoeat() {
    const eatingImage = "Aset/kitten/makan.gif";
    const idleImage = "Aset/kitten/kitten-idle.gif";
  ...
  function changeImageToSleeping() {
    const sleepingImage = "Aset/kitten/tidur.gif";
    const idleImage = "Aset/kitten/idle.gif";
  ...
  function changetoobat() {
    const healingImage = "Aset/kitten/sakit.gif";
    const idleImage = "Aset/kitten/idle3.gif";
    const intervalDuration = 3000;
    const object2 = document.getElementById("object2");
